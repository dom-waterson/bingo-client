(function () {
    ...
    angular.module('Tombola.BingoClient.BingoTicket', ['Tombola.BingoClient.WinnerChecking']);
    ...
    angular.module('Tombola.BingoClient.LoginController',
        ['Tombola.BingoClient.Proxy', 'Tombola.BingoClient.UserModel', 'Tombola.BingoClient.ObjectConverter']);

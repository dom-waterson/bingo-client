(function () {
    ...
    angular.module('Tombola.BingoClient.GameController')
        .controller('gameController',['proxy', 'userModel', 'bingoModel', 'nextGameService', 'longPolling', 'tokenService', 'gameProxy',  function (proxy, userModel, bingoModel, nextGameService, longPolling, tokenService, gameProxy) {
            var me = this;
            me.user = userModel;
            me.bingo = bingoModel;
